package com.juyikeji.myappjubao.slip;
...
//		refreshingAnimation.setInterpolator(lir);
    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateImageView.setBackgroundResource(R.mipmap.refresh1);
                break;
            case FAIL:
            default:
                // 刷新失败
    ...
    private void initView() {
        ...
        AnimationDrawable anim=(AnimationDrawable) pullView.getBackground();
        anim.start();
